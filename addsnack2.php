...
<body>
        ...
        <form action="addsnack.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <select class="form-control" id="categoryid" name="categoryid">
                    <option value="">Select Category</option>
                    <?php
                    // Reuse the database connection and category query code
    ...
    <!-- Display snacks in DataTable format here -->
    <div class="container mt-4">
        ...
        <table class="table" id="myTable">
            ...
            <tbody>
                <?php
                // Fetch snack data from the database and populate the table rows
    ...
    var categoryid = tr.find("td:eq(1)").text();
    var subcategoryid = tr.find("td:eq(2)").text();
    
    var snackname = tr.find("td:eq(3)").text();
    var description = tr.find("td:eq(4)").text();
    var image = tr.find("td:eq(5)").text(); // Assuming this is a URL to the image
    ...
    $('#snacknameEdit').val(snackname);
    $('#descriptionEdit').val(description);
    $('#imageEdit').attr('src', image); // Assuming 'image' is an image URL
    $('#priceEdit').val(price);
    $('#statusEdit').val(status);
    $('#snackidEdit').val($(this).attr('id'));
