          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <div class="nav-profile-text">
                <p class="mb-1 text-black">Niraj Oza</p>
              </div>
            </a>
        ...
        <li class="nav-item nav-profile">
          <a href="#" class="nav-link">
            ...
            <div class="nav-profile-text d-flex flex-column">
              <span class="font-weight-bold mb-2">Niraj Oza</span>
            ...
            <div class="card-body">
              ...
              <form class="forms-sample">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Sub-category Name">
                </div>
                <div class="form-group">
                  <label for="exampleInputUsername1">Category Id</label>
                  <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Category Id">
                </div>
                <div class="form-group">
                  <label for="exampleInputUsername1">Status</label>
                  <!-- <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Status"> -->
