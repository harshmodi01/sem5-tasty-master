			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 text-center logo-wrap">
						<div id="fh5co-logo"><a href="index.php">Jay Bhavani Locho<span>.</span></a></div>
					</div>
				...
				<div class="col-md-12 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							<h1>The Best Online Food Store <em>&amp;</em><br><p style="color: #f4ff0b;">Jay Bhavani Locho</p>  <em>in</em> Surat</h1>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							...
							$sql = "SELECT name, email, message FROM contact WHERE id=8"; // Modify the query as needed
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<!-- <span class="posted_on">Feb. 15th 2016</span> -->
							<?php include("connect.php");
							$sql = "SELECT name, email, message FROM contact WHERE id=7"; // Modify the query as needed
							$result = $conn->query($sql); 
							if ($result->num_rows > 0) 
							{
								$row = $result->fetch_assoc();
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<!-- <span class="posted_on">Feb. 15th 2016</span> -->
							<?php include("connect.php");
							$sql = "SELECT name, email, message FROM contact WHERE id=6"; // Modify the query as needed
							$result = $conn->query($sql); 
							if ($result->num_rows > 0) 
							{
								$row = $result->fetch_assoc();
