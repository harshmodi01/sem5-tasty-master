...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Extract the numeric part of the pincode from the selected option
...
<script>
    function validateDateOfBirth() {
        ...
        maxDate.setFullYear(today.getFullYear() - 10); // Calculate date 10 years ago

        if (inputDate > today) {
            alert("Please enter a date in the past.");
            document.getElementById("dateofbirth").value = ""; // Clear the input
            return false;
